...
class DummyData {
  static final List<Map<String, dynamic>> headlines = [
  ...
  static final List<String> categories = ['Politics', 'Tech', 'Sports', 'Entertainment'];
  ...
  static final List<Map<String, dynamic>> recommendedNews = [
