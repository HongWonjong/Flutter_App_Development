...
class _CostCalculatePageState extends State<CostCalculatePage> {
  Map<String, int> _fixedCostByFoodType = {};
  Map<String, int> _variableCostByFoodType = {};
  Map<String, List<CostItem>> _costListByFoodType = {}; // 수정
  int quantity = 1;
  ...
  double calculateCostRate() {
    ...
    return unitCost / widget.chickenPrice * 100;
  }
