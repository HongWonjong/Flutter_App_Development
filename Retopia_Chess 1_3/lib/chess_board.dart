...
class _ChessBoardState extends State<ChessBoard> {
  ...
  void handleEnPassantCapture(int index, int newPosition) {
    ...
    if (pieces[index] is Pawn) {
      ...
      if (movingPawn.justMadeDoubleJump) {
        ...
        int capturedPieceIndex = pieces.indexWhere((piece) => piece.position == capturePosition);
  ...
  void handleCapture(int index, int newPosition) {
    int capturedPieceIndex = pieces.indexWhere((piece) => piece.position == newPosition && piece.isWhite != pieces[index].isWhite);
  ...
  void setDoubleJumpFlag(int index, int newPosition) {
    ...
    if (pieces[index] is Pawn && (newPosition - pieces[index].position).abs() == 16) {
