  ...
  runApp(MaterialApp(
    ...
    routes: {
      ...
      "/calculate": (context) {
        ...
        return CostCalculatorScreen(costList: args['costList'], quantity: args['quantity'], foodPrice: args['itemPrice']);
      },
    },
  ));
}
              ...
              itemBuilder: (context, index) {
                ...
                return ExpansionTile(
                  title: Row(
                    ...
                    children: [
                      Text(foodType),
                      Text('판매량: ${costItemList.first.quantity}개'),
                    ],
                  ),
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          if(costItem.isFixedCostPerUnit) Text(
                              "개당 고정원가: ${formatCurrency(costItem.unitCost.toDouble() / costItemList.first.quantity)}원"
                          ),
                        ],
                      ),
                      trailing: Row(
                        ...
                        children: [
                          ...
                          Text(
                            costItem.isFixedCostPerUnit
                                ...
                                : "합계: ${formatNumber(costItem.unitCost * costItemList.first.quantity)}원",
                          ),
                        ],
                      ),
                    ),
